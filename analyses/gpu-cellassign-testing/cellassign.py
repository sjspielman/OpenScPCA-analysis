...
# The contents of this script were taken from https://github.com/AlexsLemonade/scpca-nf/blob/main/bin/predict_cellassign.py
...
#default is 128 print(scvi.settings.batch_size)
#default is False print(scvi.settings.jax_preallocate_gpu_memory)
...
if subset_adata.n_obs < 30 or gene_exp.sum() == 0:
    ...
    ####### SJS ADDING accelerator="gpu" ARGUMENT ###########
