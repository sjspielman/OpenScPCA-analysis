...
The input file `r params$fetal_kidney_path` is the output of the script `prepare-fetal-references.R`.


## Output file

We will save the result of the differential expression analysis in `results/references/00b_marker_compartment_fetal_kidney_Stewart.csv` and `results/references/00b_marker_cell-type_fetal_kidney_Stewart.csv` .
The notebook is saved in the `results/references/` directory.
...
write_csv(de_results, file = file.path(path_to_output, "00b_marker_compartment_fetal_kidney_Stewart.csv"))
```
...
write_csv(de_results, file = file.path(path_to_output, "00b_marker_cell-type_fetal_kidney_Stewart.csv"))
```
